...
import '../assets/tailwind.css';
 const FormTestApp = ()=> {
    ...
    //as we are in React.StrictMode it will double the messages 
    getTitleOfPageOpener();
    }, [])
    ...
    <div className="space-y-12">
      <div className="border-b border-gray-900/10 pb-12">
        <h2 className="text-base font-semibold leading-7 text-gray-900">Who opened me??????? :(( </h2>
        <p className="mt-1 text-sm leading-6 text-gray-600">{title? title: "Defecto"}</p>
